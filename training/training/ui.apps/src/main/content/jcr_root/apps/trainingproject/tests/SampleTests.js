 ...
 */
new hobs.TestSuite("TrainingProject Tests", {path:"/apps/trainingproject/tests/SampleTests.js", register: true})

    .addTestCase(new hobs.TestCase("Hello World component on english page")
        .navigateTo("/content/trainingproject/en.html")
        .asserts.location("/content/trainingproject/en.html", true)
